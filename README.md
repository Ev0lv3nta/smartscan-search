...
Сейчас репозиторий содержит Android-приложение SmartScan Search и локальные модули SmartScan SDK из зафиксированной upstream-ревизии. Ближайший этап — сформировать воспроизводимый model pack, после чего последовательно заменить каталог, индекс и ранжирование.
